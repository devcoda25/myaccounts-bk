...
export async function bootstrap() {
    ...
    fastify.addHook('onRequest', async (req, res) => {
        if (req.url.startsWith('/oidc')) {
            ...
            // We removed the '/oidc' stripping logic here because the provider is 
            // configured with the '/oidc' issuer. By leaving the prefix, the 
            // provider correctly identifies its internal routes.
